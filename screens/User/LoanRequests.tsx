                ...
                <View style={styles.container}>
                    <View style={{flex: 1, alignItems: 'center',}}>
                        <View style={{
                            ...
                            <TouchableOpacity onPress={() => navigation.navigate('Modal')} style={{
                                ...
                                <MaterialCommunityIcons style={{ paddingHorizontal: 5, paddingVertical: 5 }}
                                                        name="account" color="#FFFFFF" size={30}/>
                            </TouchableOpacity>
                        </View>
